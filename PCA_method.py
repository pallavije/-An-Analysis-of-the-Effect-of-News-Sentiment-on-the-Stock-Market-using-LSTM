...
x_train, x_test, y_train, y_test = train_test_split(newHeadlinesData, normalizedOpeningprice, test_size=0.1,
                                                    random_state=3)
...
# defining pipeline with PCA and Random forest regressor

model = Pipeline([('pca', PCA()), ('rf', RandomForestRegressor())])
model.fit(x_train,y_train)

ypred = model.predict(x_test)
error = mse(y_test,ypred)
print()
print("\n\nThe error score in PCA : ",error)
