...
RF_acc = train_predict(RF, x_train, y_train, x_test, y_test)
print("The error score of Random Forest Regressior is : %f" % RF_acc)
KNN_acc = train_predict(KNN, x_train, y_train, x_test, y_test)
print("The error score of K-nearest neighbour is : %f" % KNN_acc)
AB_ac = train_predict(AB, x_train, y_train, x_test, y_test)
print("The error score of adaboosting is : %f" % AB_ac)
GB_ac = train_predict(GB, x_train, y_train, x_test, y_test)
print("The error score of gradient boosting is : %f" % GB_ac)



'''
# For all model accuracy and Graph
